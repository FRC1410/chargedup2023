...
public interface Constants {
    ...
    AprilTagFieldLayout fieldLayout = new AprilTagFieldLayout(List.of(
            ...
            new AprilTag(6, new Pose3d(15.513558, Units.inchesToMeters(141.5), 0.462788, new Rotation3d(new Quaternion(1, 0, 0, 0)))),
            new AprilTag(7, new Pose3d(15.513558, Units.inchesToMeters(207.5), 0.462788, new Rotation3d(new Quaternion(1, 0, 0, 0)))),
            new AprilTag(8, new Pose3d(15.513558, Units.inchesToMeters(273.5), 0.462788, new Rotation3d(new Quaternion(1, 0, 0, 0))))
            ), 16.53, 8.01);
}
