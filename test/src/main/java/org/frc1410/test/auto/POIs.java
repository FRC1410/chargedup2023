...
public interface POIs {
	...
	Pose2d RED_INSIDE_WAYPOINT = new Pose2d(inchesToMeters(0), inchesToMeters(0), new Rotation2d());
	Pose2d RED_OUTSIDE_WAYPOINT = new Pose2d(inchesToMeters(0), inchesToMeters(0), new Rotation2d());
	...
	Pose2d BLUE_INSIDE_WAYPOINT = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
	Pose2d BLUE_OUTSIDE_WAYPOINT = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
}