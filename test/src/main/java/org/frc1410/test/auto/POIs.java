...
public interface POIs {
    ...
    Pose2d TEST_S_CURVE = new Pose2d(1,1, Rotation2d.fromDegrees(0));
    Pose2d TEST_S_CURVE_LARGE = new Pose2d(-2,-2, Rotation2d.fromDegrees(0));
    ...
    Pose2d OUTSIDE_CHARGING_STATION_FAR = new Pose2d(inchesToMeters(210.12), inchesToMeters(96.39), Rotation2d.fromDegrees(0));
