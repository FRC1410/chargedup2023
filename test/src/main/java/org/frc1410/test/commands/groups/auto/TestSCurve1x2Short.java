...
public class TestSCurve1x2Short extends SequentialCommandGroup {
    public TestSCurve1x2Short(Drivetrain drivetrain) {
        drivetrain.resetPoseEstimation(START);

        addCommands(
                Trajectories.testSCurve1x2Short(drivetrain),
