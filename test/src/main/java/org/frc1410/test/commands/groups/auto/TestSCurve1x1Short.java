...
public class TestSCurve1x1Short extends SequentialCommandGroup {
	public TestSCurve1x1Short(Drivetrain drivetrain) {
        drivetrain.resetPoseEstimation(START);

        addCommands(
            Trajectories.testSCurve1x1Short(drivetrain),
