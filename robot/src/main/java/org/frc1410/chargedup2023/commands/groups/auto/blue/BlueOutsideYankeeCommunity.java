...
public class BlueOutsideYankeeCommunity extends SequentialCommandGroup {
	public BlueOutsideYankeeCommunity(Drivetrain drivetrain, LBork lbork, Elevator elevator, Intake intake) {
		addCommands(
