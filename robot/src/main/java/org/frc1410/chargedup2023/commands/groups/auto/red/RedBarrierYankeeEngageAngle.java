...
public class RedBarrierYankeeEngageAngle extends SequentialCommandGroup {
	public RedBarrierYankeeEngageAngle(Drivetrain drivetrain, LBork lbork, Elevator elevator, Intake intake) {
		addCommands(
