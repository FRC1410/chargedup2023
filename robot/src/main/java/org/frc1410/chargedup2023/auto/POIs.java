...
public interface POIs {
	...
	Translation2d BLUE_OKLAHOMA_BACK = new Translation2d(inchesToMeters(190), inchesToMeters(185));
	...
	Translation2d RED_OKLAHOMA_BACK = new Translation2d(inchesToMeters(461.22), inchesToMeters(185));
