...
public interface POIs {
	...
	Pose2d RED_LEFT_YANKEE_ANGLED_NODE = new Pose2d(-inchesToMeters(40), inchesToMeters(), new Rotation2d());
	Pose2d RED_RIGHT_YANKEE_ANGLED_NODE = new Pose2d(-inchesToMeters(40), inchesToMeters(), new Rotation2d());
	...
	Pose2d BLUE_LEFT_YANKEE_ANGLED_NODE = new Pose2d(inchesToMeters(), inchesToMeters(), Rotation2d.fromDegrees(180));
	Pose2d BLUE_RIGHT_YANKEE_ANGLED_NODE = new Pose2d(inchesToMeters(), inchesToMeters(), Rotation2d.fromDegrees(180));
