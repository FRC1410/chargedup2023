...
public interface POIs {
	...
	Pose2d RED_LEFT_YANKEE_ANGLED_NODE = new Pose2d(0, 0, new Rotation2d());
	Pose2d RED_RIGHT_YANKEE_ANGLED_NODE = new Pose2d(0, 0, new Rotation2d());
	...
	Pose2d BLUE_LEFT_YANKEE_ANGLED_NODE = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
	Pose2d BLUE_RIGHT_YANKEE_ANGLED_NODE = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
